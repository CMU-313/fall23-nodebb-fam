    ...
    it('should search child categories', (done) => {
        async.waterfall([
            ...
            function (result, next) {
                ...
                const regexPattern0 = /^child category topic \((1[0-2]|0[1-9])&#x2F;(3[01]|[12][0-9]|[1-9])&#x2F;\d{4}, (1[0-2]|[1-9]):([0-5][0-9]):([0-5][0-9]) (AM|PM)\)$/;
                ...
                const regexPattern1 = /^java mongodb redis \((1[0-2]|0[1-9])&#x2F;(3[01]|[12][0-9]|[1-9])&#x2F;\d{4}, (1[0-2]|[1-9]):([0-5][0-9]):([0-5][0-9]) (AM|PM)\)$/;
